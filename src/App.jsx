...
const FAQ_ITEMS = [
  {
    ...
    answer: "LearnOps runs in your browser. No extensions, no desktop apps, no plugins. Paste a link or upload a transcript, and the pipeline starts immediately.",
  },
  {
    question: "Is this just fancy flashcards?",
    answer: "No. Flashcards test isolated facts. LearnOps stress-tests your understanding of causal mechanisms — how and why things work, not just what they're called. The Socratic drilling adapts to your specific gaps.",
  },
  {
    ...
    <div className="min-h-screen bg-[#0b1326] text-[#dae2fd]">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#0b1326]/60 backdrop-blur-xl">
        <div className="flex justify-between items-center px-8 py-4 max-w-7xl mx-auto">
          <div className="text-2xl font-bold tracking-tighter text-[#c4c0ff] font-display">LearnOps</div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <img
              ...
              alt="3D isometric visualization of the LearnOps study pipeline"
        ...
        <div className="max-w-7xl mx-auto">
          <div className={`grid grid-cols-1 lg:grid-cols-2 rounded-lg overflow-hidden bg-[#1c2540] shadow-2xl transition-all duration-700 ${probVis ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            <div className="p-12 bg-[#222a3d]">
              <h3 className="font-display text-3xl font-bold mb-8 text-[#3cddc7]">The LearnOps Flow</h3>
              <ul className="space-y-6">
      ...
      <footer className="w-full border-t border-[#dae2fd]/10 bg-[#0b1326]">
        <div className="flex flex-col md:flex-row justify-between items-center px-12 py-16 gap-8 w-full max-w-7xl mx-auto">
          <div className="flex flex-col gap-2">
            <div className="font-display font-bold text-[#c4c0ff] text-xl">LearnOps</div>
